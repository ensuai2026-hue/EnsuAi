            ...
            <div className="relative pt-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 relative z-10">
                {[
                  {
                    id: "01",
                    title: "Analisis Personaliti",
                    desc: "Mengkaji DNA dan karakter unik anda melalui diagnosis AI yang mendalam.",
                    icon: Fingerprint,
                    label: "Intelligence"
                  },
                  {
                    id: "02",
                    title: "Inject DNA Produk",
                    desc: "Memindahkan intipati karakter anda ke dalam formulasi dan visi produk.",
                    icon: Dna,
                    label: "Alchemy"
                  },
                  {
                    ...
                    desc: "Mencari 'perfect match' kategori produk yang sejajar dengan aura anda.",
                    icon: Target,
                    label: "Selection"
                  },
                  {
                    ...
                    desc: "Melancarkan jenama ikonik anda ke pasaran dengan strategi alpha.",
                    icon: Rocket,
                    label: "Execution"
                  }
                ].map((item, index) => (
                  ...
                  >
                    {/* Progress Indicator Node (Outside Card) */}
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 flex flex-col items-center">
                      ...
                      {/* Floating Fasa Label */}
                      <span className="mt-3 text-[10px] font-black text-oem-primary/40 tracking-widest uppercase">
                        Fasa {item.id}
                      </span>
                    </div>
                    ...
                    <div className="organic-card p-8 md:p-10 flex flex-col items-start text-left bg-white/60 backdrop-blur-md border border-emerald-50 hover:bg-white hover:shadow-[0_40px_80px_-15px_rgba(16,185,129,0.12)] transition-all duration-700 h-full">
                      <div className="w-full flex justify-between items-start mb-8">
                        ...
                        <div className="text-[9px] font-black uppercase tracking-[0.4em] text-emerald-600/40">
                          {item.label}
                        </div>
                      </div>
                      
                      <h3 className="text-xl md:text-2xl font-extrabold mb-4 text-oem-dark uppercase tracking-tight leading-tight group-hover:text-oem-primary transition-colors">
                        {item.title}
                      </h3>
                      
                      <p className="text-xs md:text-sm text-oem-dark/50 font-medium leading-relaxed italic pr-2">
                        {item.desc}
                      </p>
                    </div>
                  </motion.div>
